                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h1 align="center" style="margin-top: 10px; color:black; font-size:30px; text-shadow: 5px 3px 3px #888;">MARKSHEET MANAGEMENT SYSTEM</h1>
                                </div>
                            </div>
                            <!-- /.row -->
...
$query = "SELECT  studentstbl.studentName,studentstbl.rollNo,studentstbl.regDate,studentstbl.studentId,studentstbl.imagename,studentstbl.fatherName,studentstbl.motherName,studentstbl.village,classestbl.className,classestbl.year from studentstbl join classestbl on classestbl.id=studentstbl.classId where studentstbl.rollNo=$rollNo  and studentstbl.classId=$classid ";
